...
FactoryGirl.create(:timeslot, initiator: Student.first, challenge_id: challenge1.id, start_at: Time.zone.now.beginning_of_hour + 8.hour, end_at: Time.zone.now.beginning_of_hour + 9.hours)
FactoryGirl.create(:timeslot, initiator: Student.first, challenge_id: challenge1.id, start_at: Time.zone.now.beginning_of_hour + 9.hour, end_at: Time.zone.now.beginning_of_hour + 10.hours)
FactoryGirl.create(:timeslot, initiator: Student.first, challenge_id: challenge1.id, start_at: Time.zone.now.beginning_of_hour + 10.hour, end_at: Time.zone.now.beginning_of_hour + 11.hours)
